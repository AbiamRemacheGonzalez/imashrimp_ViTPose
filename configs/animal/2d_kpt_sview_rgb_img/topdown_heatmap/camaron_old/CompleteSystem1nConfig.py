...
pretrain_pth = "C:/Users/Tecnico/Downloads/vitpose-s.pth"#"D:/1_SHRIMP_PROYECT/6_COMPLETE_SYSTEM/results/multiple/crop_complete_system_multiple_v0_2025_08_05/3_pose_estimation/1_train/experiment_23KP_lateral_2025_08_05/winner_16_3e-05_210/best_PCK_epoch_203.pth"  # None  # Path to the lateral pre-trained model
...
# Path to the detection pretrained model
pretrain_detection_pth = "D:/_github_directory/Imashrimp/0_detection/detection_manager/results/inference/best.pt"
# Path to the dataset
dataset_path = "D:/1_SHRIMP_PROYECT/2_DATASET_MANAGEMENT/MULTIPLE_DATASET_MANAGEMENT/DATASETMANAGEMENT/results/complete_system/shrimp_dataset_complete_system_v0_2025_10_09_1n"
...
compact_config = "1_pose_estimation/imashrimp_ViTPose/configs/animal/2d_kpt_sview_rgb_img/topdown_heatmap/camaron/VitPose_huge_camaron_rgbd_compact_256x192.py"
complete_system_config = dict(
    ...
    networks=[compact_config, pretrain_pth],
