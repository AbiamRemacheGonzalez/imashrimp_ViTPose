...
from imashrimp_ViTPose.mmpose.apis import (inference_pose_lifter_model,
                         inference_top_down_pose_model, vis_3d_pose_result)
from imashrimp_ViTPose.mmpose.apis.inference import init_pose_model
...
def main():
    ...
    if args.only_second_stage:
        from imashrimp_ViTPose.mmpose.apis.inference import _xywh2xyxy
