...
if __name__ == '__main__':
    ...
    pose_dir = general_cfg.complete_system_config.complete_system_data_root + "/1_pose_estimation"
    ...
    for data_root in pose_data_roots:
        ...
        view = splits[3]
        nkp = splits[2][:-2]
        data_root = os.path.join(general_cfg.complete_system_config.complete_system_data_root, "1_pose_estimation", data_root)
