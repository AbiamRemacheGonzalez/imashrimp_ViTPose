...
from ..base import Kpt2dDeepSviewRgbImgTopDownDataset


@DATASETS.register_module()
class AnimalCamaronDatasetDeep(Kpt2dDeepSviewRgbImgTopDownDataset):
    ...
    Args:
        ...
        test_mode (bool): Store True when building val or
    ...
    def evaluate(self, results, res_folder=None, metric='PCK', err_dis=False, **kwargs):
        ...
        valid_kpts = []
        for image_id in kpts_1.keys():
            img_kpts = kpts_1[image_id]
            for n_p in img_kpts:
                box_score = n_p['score']
                kpt_score = 0
                valid_num = 0
        ...
        info_str_1 = self._do_python_keypoint_eval(res_file)
        name_value_1 = OrderedDict(info_str_1)
    ...
    def _sort_and_unique_bboxes_dict(self, kpts, key='bbox_id'):
