...
class LoadOneChannelImageFromFile:
    ...
    def __call__(self, results):
        ...
        #             raise KeyError('Error no controlado. En principio nunca debería entrar aquí. mmpose/datasets/pipelines/loading_depth/__call__')
        #         else:
        ...
        depth_image_nor = depth_image_nor.astype(np.float32)
        results['img'] = depth_image_nor
        return results
