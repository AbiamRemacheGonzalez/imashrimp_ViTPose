...
from imashrimp_ViTPose.mmpose.models.backbones import ShuffleNetV2
from imashrimp_ViTPose.mmpose.models.backbones.shufflenet_v2 import InvertedResidual
